...
5.  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Set your GitHub credentials \AddToHookNext{env/Highlighting/begin}{\small}
...
6.  3Create your GitHub repository \AddToHookNext{env/Highlighting/begin}{\small}
...
data <- cps$earnwk_black

# Make the histogram
data %>%
  ggplot( aes(x=earnwk_black)) +
...
ggplot(cps, aes(x=cps$educ, y=cps$earnwk)) + 
    geom_point()
```
